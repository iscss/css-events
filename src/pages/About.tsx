...
import { Mail, Globe, Users, Lightbulb, GraduationCap } from "lucide-react";
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center max-w-4xl mx-auto">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 rounded-full text-sm font-medium mb-8 border border-indigo-200 shadow-sm">
                Built with care for the CSS Community
              </div>
              ...
              <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                Connecting the <span className="font-semibold text-slate-700">computational social science</span> community through events, talks, and workshops.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-2 text-center">
                <p className="text-lg text-slate-700 leading-relaxed">
                  CSS Events exists to <strong>bring the computational social science community together</strong> through accessible, engaging events — from Q&As with leading researchers to hands-on workshops.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed">
                  Whether you're attending online or in person, we make it easy to stay connected and keep learning.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                CSS Events is brought to you by the same team behind CSS Jobs.
              </p>
            </div>
